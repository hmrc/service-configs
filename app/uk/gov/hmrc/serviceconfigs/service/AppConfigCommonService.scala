...
class AppConfigCommonService @Inject()(
  ...
  def serviceCommonConfigYaml(env: SlugInfoFlag, serviceType: String): Future[Option[String]] = {
    ...
    appConfigCommonRepository.findByFileName(s"${env.asString}-$st-common.yaml")
  }
}
